...
<tr bgcolor=blue><td align=center><font SIZE=6 color=white>SAVING HANDS HOSPITAL
 </font></td></tr>
...
<tr bgcolor=#045FB4><td ><font size=4 color=white>Save
...
if ($error==0) {
 ...
 mysqli_query($con,"insert into appt(adoctor,apatient,atime,adate,ashow)
